...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-4.1.0.xcframework.zip",
			checksum: "3b4ef46b1c8c1a5bfbf28e4043b835dd947ac4cc6816c774d2ba4fbbc6ef67aa"
		)
	]
)