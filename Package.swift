...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-5.0.0-rc.1.xcframework.zip",
			checksum: "955744c0df3f0f5630413286199d7d3c4e33959ad29eb76e8302a923a5d91558"
		)
	]
)