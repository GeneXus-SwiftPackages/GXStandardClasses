...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230309100338.xcframework.zip",
			checksum: "ecc16efa3f46bd9a24a3739c5ffe3cf508e7e578df86ae4e962e7750963828df"
		)
	]
)