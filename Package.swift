...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-4.0.0-rc.0.xcframework.zip",
			checksum: "04a28feb1da3e06454991daba50e0d197b0281dd6105033fc547392d95e77632"
		)
	]
)