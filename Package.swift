...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.6.0-rc.0.xcframework.zip",
			checksum: "180e648779f7a8266e593be40fa3a231f07512354dfcd78035507185ff78c3e5"
		)
	]
)