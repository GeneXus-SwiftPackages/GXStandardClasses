...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.0.0-beta.23.xcframework.zip",
			checksum: "2a8b8bff4698026d820126b5b61147e6805423da2c1fc12d1d074e9a046029db"
		)
	]
)