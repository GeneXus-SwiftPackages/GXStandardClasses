...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.0.0-beta.44.xcframework.zip",
			checksum: "b884f632c5cc94e7028ea4805a74565a66bd87c87169643a56454a5e24bb10df"
		)
	]
)