...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.1.0-beta.18.xcframework.zip",
			checksum: "6765c1a3f01ec79651a7f7cda5496768d5b47d46f88c022019963b205a188906"
		)
	]
)