...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-3.0.0-rc.8.xcframework.zip",
			checksum: "d5e08d6a4a174ffb8f32649384933a78caf1c3b45dc5d2da814f6264d5305d17"
		)
	]
)