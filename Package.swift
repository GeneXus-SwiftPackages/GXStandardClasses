...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.2.0-rc.36.xcframework.zip",
			checksum: "fb4103fdd63e39789fba885da8e87365e483e1897b26f95b66f3a7515252df0a"
		)
	]
)