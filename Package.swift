...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.14.xcframework.zip",
			checksum: "0f6a39fd273fdc3e7900c4343d1e5402b9bfd36cd095b8e6a0f10ec8ca7ee0c2"
		)
	]
)