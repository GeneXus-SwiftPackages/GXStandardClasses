...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230315182831.xcframework.zip",
			checksum: "e8f817a1d07f8d2fca39bf929044e5f3e382f86ecd00320f215be9bba6ba3765"
		)
	]
)