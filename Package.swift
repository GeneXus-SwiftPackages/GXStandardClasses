...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-1.4.27.xcframework.zip",
			checksum: "c838ec05245e1aac91f4e5246bd314b388e5dba73041f9d6575f3e4fc5f06e52"
		)
	]
)