...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.2.0-beta.36.xcframework.zip",
			checksum: "b6834d95aa8192fe86cafe3444145ff9c2fcdd27f6d420a167ba351086f0580f"
		)
	]
)