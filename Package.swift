...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-3.1.0.xcframework.zip",
			checksum: "bb78199aee76f7eeb43adc154dec5d95f969770e01bd6218d2cebe715ef6fa14"
		)
	]
)