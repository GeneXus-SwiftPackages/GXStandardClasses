...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.0.0-beta.45.xcframework.zip",
			checksum: "c4d78b42456f17faa8135e0e08970b88eb9fd7624746f7c9b9410d72ae93c549"
		)
	]
)