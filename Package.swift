...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.2.0-beta.26.xcframework.zip",
			checksum: "39e3f09750a80ec58ff5d96b64e2ed7a65521af61082505cf482c2704180e6ca"
		)
	]
)