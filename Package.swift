...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.15.xcframework.zip",
			checksum: "4331b22a9cbcae88bd0a346291fb38ee4ac8843c53aa751ec8da8362622f011f"
		)
	]
)