...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.2.0-beta.19.xcframework.zip",
			checksum: "e0578c2362e47f1f670bd0aa949627d91133c5131043dd57a5faa25ef66311cc"
		)
	]
)