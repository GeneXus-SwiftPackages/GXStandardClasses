...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.4.xcframework.zip",
			checksum: "1a74cb712829b875fbec96b88ffadab782bc5df5aecc06438c2e0b4a45d08c2d"
		)
	]
)