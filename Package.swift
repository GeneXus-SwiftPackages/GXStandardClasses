...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.4.0-beta.13.xcframework.zip",
			checksum: "d1eb7210e76637d3b8110a125184f4c6880937c6c2c724d49e9a4a517535856a"
		)
	]
)