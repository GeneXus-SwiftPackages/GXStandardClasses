...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta.20230616185027.xcframework.zip",
			checksum: "871f7d9f575029a177d7c2787b97c93f35a038462fa1eea12657ab204e97576d"
		)
	]
)