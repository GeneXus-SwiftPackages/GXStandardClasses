...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.21.xcframework.zip",
			checksum: "89a7222bcb11f58e6be2707a962c31eecab55d8e0ae1c6f91338279020804d32"
		)
	]
)