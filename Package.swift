...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.8.xcframework.zip",
			checksum: "5d33fc132a7e31555d7ace80a970371ffd2c4f9af1c69f693dfd43c9b1d4b1f8"
		)
	]
)