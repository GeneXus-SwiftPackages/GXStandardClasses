...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.1.0-rc.5.xcframework.zip",
			checksum: "0cb56d02d45098fb5ebf8dbe30970e4d6471a7e0557cc5f4c89176de7b7a8a76"
		)
	]
)