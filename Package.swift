...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.28.xcframework.zip",
			checksum: "6acce82da94193cd1bf4fb968e39c1d458acc7d5e4537401276b5d8882b0e985"
		)
	]
)