...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.0.0-beta.16.xcframework.zip",
			checksum: "083fbd1689c0dfc2ad2c21d0527c7ed8a145dbd313dfc40dde335c01b5a77b95"
		)
	]
)