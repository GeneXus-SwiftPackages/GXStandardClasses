...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-4.1.0-rc.14.xcframework.zip",
			checksum: "6ad528d38b6a83185cf431295f757f24605fb995b28de183192994a64c8e21d8"
		)
	]
)