...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.6.0-beta.0.xcframework.zip",
			checksum: "1448d03d1753c81abebc612457bb145587dc627c1574861f07bc4d8831ee96d8"
		)
	]
)