...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.0.0-beta.18.xcframework.zip",
			checksum: "4c8bbdf0c527ba887e0b0e049fb8cb1fc1998ebf2541f5a1381e7d90ae51e2fb"
		)
	]
)