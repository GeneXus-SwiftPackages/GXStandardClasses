...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.2.0-beta.40.xcframework.zip",
			checksum: "d08403663850f9aa4de4b2c2bf6a70a80fbf742ca62b1c4a84dee3e900ee16e8"
		)
	]
)