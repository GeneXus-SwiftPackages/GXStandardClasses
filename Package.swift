...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.31.xcframework.zip",
			checksum: "831a628dc561b450838d53c66b9397e9bd934140b73b90ca89261f5b2fdf9a58"
		)
	]
)