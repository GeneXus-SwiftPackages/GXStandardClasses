...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.2.0-beta.12.xcframework.zip",
			checksum: "c20186f26cf283bcebe9206b9dab532210d81e8fa1be73865c53731dd66e7ed0"
		)
	]
)