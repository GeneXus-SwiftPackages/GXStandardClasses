...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.2.0-rc.25.xcframework.zip",
			checksum: "36a1cb7a3819479d0c1491a35ba84310d1773bc512d9b2cf4344eca7ca819e93"
		)
	]
)