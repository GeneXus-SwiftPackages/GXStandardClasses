...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.1.0-beta.12.xcframework.zip",
			checksum: "cddfb5813007177bc979f064b8f235d47290404913c7efaed895f09251716329"
		)
	]
)