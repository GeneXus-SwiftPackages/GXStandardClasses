...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-1.2.1.xcframework.zip",
			checksum: "ec52af0f416c9735b644d204130b612b08a744c68e20494fcea8d639a823d888"
		)
	]
)