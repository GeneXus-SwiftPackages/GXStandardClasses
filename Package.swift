...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.3.xcframework.zip",
			checksum: "e4c74aae51a75a7707009277446a5c00f2491bc319e76eac859542cdccc79c6e"
		)
	]
)