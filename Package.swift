...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-2.1.0-rc.25.xcframework.zip",
			checksum: "1ff95cde5e41baeb00d5e7c0a5b5c5c2050ca41b6087f9c454e14b75e1b76a4a"
		)
	]
)