...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.2.0-beta.15.xcframework.zip",
			checksum: "33b2265556e31267d38ea4820c407bd6cf5547841fd893fa384b2f66f856e844"
		)
	]
)