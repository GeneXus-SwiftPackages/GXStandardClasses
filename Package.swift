...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.4.0-beta.3.xcframework.zip",
			checksum: "989a1c66c7bc311d29f4db37fadf04220ad7934487a7b910eef8e05995ac046a"
		)
	]
)