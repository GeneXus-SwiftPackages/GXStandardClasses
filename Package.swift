...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-4.0.17.xcframework.zip",
			checksum: "06fcd273ede8ac25bac8e9877454eef56460ee4d70321cd2d55df7defe352abd"
		)
	]
)