...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.0.0-beta.31.xcframework.zip",
			checksum: "94f1571da7c8b089b66891f016313fbe25fc194bab772b904d7989bad1c03370"
		)
	]
)