...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-2.1.0.xcframework.zip",
			checksum: "d295de8954a5c2a56ef30ee53ed3add8bb9660952eaeca156a760c22598aec57"
		)
	]
)