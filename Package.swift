...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.2.0-beta.33.xcframework.zip",
			checksum: "efa73b72d4b2c0b7dd41a58f088f50a1b39b010d1699428847525fe2bad4bebd"
		)
	]
)