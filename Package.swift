...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.25.xcframework.zip",
			checksum: "1445e65c9db74d92d5bacb23a5c1a9efeaa90024d0b67323eb54bd5539db6dd6"
		)
	]
)