...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.4.0-beta.6.xcframework.zip",
			checksum: "1410d1a7a5c199919005f48171dd2312802e38065bad4080aedbfe1a48c14b2d"
		)
	]
)