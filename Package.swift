...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.0.0-beta.15.xcframework.zip",
			checksum: "6b2199a667da315d532365d05332850b144f114fd9ece971b3e2b5d4bf82f4ed"
		)
	]
)