...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.2.0-beta.20.xcframework.zip",
			checksum: "5377ecf7a002fe0c0ad9df19329cd63088dc191fe18fe3ed1db4032071e0fcb2"
		)
	]
)