...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.1.0-beta.24.xcframework.zip",
			checksum: "d5d30d7e737971165e1017e1d168539162efe78ce1e399ba220c8034f33f9113"
		)
	]
)