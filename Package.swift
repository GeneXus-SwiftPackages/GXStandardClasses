...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.0.0-beta.13.xcframework.zip",
			checksum: "590510f1db9422247c65035e4c4852249ee00dfb51cd1bc614fbec5de9af0a31"
		)
	]
)