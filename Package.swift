...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.3.0-rc.13.xcframework.zip",
			checksum: "e6ce6e5537b0bf84a088f43f215b7863e893b6faf885c6ae32a4834cc0b9608f"
		)
	]
)