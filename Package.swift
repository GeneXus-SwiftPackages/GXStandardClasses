...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.1.0-beta.23.xcframework.zip",
			checksum: "a8c9090242f882aaf470965d31f8dff9ccb4bcf9b5be6ad6693c7b069902a88b"
		)
	]
)