...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-2.0.18.xcframework.zip",
			checksum: "dbad09e0d9b77d078bf34fcc5b1f8a5385f682bb03f0f87dd40f2b6f4d09c963"
		)
	]
)