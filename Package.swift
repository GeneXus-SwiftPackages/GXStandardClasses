...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.3.0-beta.5.xcframework.zip",
			checksum: "e278f72355cb1ff9bf076a1342f5053b4abb941b0f9615709868b220252c10d4"
		)
	]
)