...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.4.0-rc.1.xcframework.zip",
			checksum: "235a28850d4ed30e11b76c457e12aa5b65a31e4d7aa2153e8810a04983fd00c4"
		)
	]
)