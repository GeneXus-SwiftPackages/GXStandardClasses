...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-4.0.7.xcframework.zip",
			checksum: "d048f6264ff2277857fc89640893d2634359dbc80adddd150c1bc8a10157a134"
		)
	]
)