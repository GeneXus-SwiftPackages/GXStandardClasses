...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.3.0-beta.3.xcframework.zip",
			checksum: "fc0da9f0c0557a8663107d040131ad9c6742068434dd0ed2244675cf2e67bbdc"
		)
	]
)