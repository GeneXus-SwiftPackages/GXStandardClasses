...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.20.xcframework.zip",
			checksum: "e851b51eadf656db77bb1d86cddd331e48d45e05c4f34e0dbf60bbd5d64e3cca"
		)
	]
)