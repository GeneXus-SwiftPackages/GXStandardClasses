...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-4.1.1.xcframework.zip",
			checksum: "8af1c384551e55a672dce7858018130469c26c90ec514ae23a93d1a9501e1f15"
		)
	]
)