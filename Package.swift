...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.0.0-beta.9.xcframework.zip",
			checksum: "3c2c66bdc865f3ba361309e0e0022305c5a7d7e85356a4a4a8436e975d1b9591"
		)
	]
)