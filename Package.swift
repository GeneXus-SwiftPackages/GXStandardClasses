...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta.20230717155910.xcframework.zip",
			checksum: "dab17d45241817abcbb8eeb2711b0216179307bc2fb71b14492bc96b4bea9041"
		)
	]
)