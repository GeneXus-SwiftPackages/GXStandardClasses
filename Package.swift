...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-4.1.0-rc.25.xcframework.zip",
			checksum: "b44bb3a587c6d6c5648d3e582dc3f869d8ad88d4b85e8d44437d3426ccc5d48c"
		)
	]
)