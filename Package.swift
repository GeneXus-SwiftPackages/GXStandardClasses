...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.3.0-rc.7.xcframework.zip",
			checksum: "69cb7eafa889bd751f0f7e13c9ba6220d784ed3a4d35ea0e0b383c39f0f9f70e"
		)
	]
)