...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.32.xcframework.zip",
			checksum: "6683f778ceb30422ba78551bc53cc7f25aafce83cc1b9d435451c46e35e9921a"
		)
	]
)