...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.0.0-beta.16.xcframework.zip",
			checksum: "1e47b8a3e005e959ef134327f27552b4be168105acb24c9b446d3aeef1af649c"
		)
	]
)