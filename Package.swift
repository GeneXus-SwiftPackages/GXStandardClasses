...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.0.0-beta.41.xcframework.zip",
			checksum: "cff610a45528faa0e716490d7b5d389e5a5cdc6a6b2fe8293d2307707738c8df"
		)
	]
)