...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.4.0-beta.14.xcframework.zip",
			checksum: "b329f59f43690e783aa361ab3786f4c092646bf00e9e659d6ece50318033d8f7"
		)
	]
)