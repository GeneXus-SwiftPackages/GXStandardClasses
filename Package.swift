...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-3.1.1.xcframework.zip",
			checksum: "421f728940939a94f9f3a248263e64bf7ca0f60ee74cdd602166662d606d679f"
		)
	]
)