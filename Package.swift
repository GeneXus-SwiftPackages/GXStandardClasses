...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.4.0-rc.5.xcframework.zip",
			checksum: "701823f927d9f2b4485633f2a8b55d371f3b7b7d374ce2382eb0737cd5f4a8af"
		)
	]
)