...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.4.0-beta.2.xcframework.zip",
			checksum: "86ad6f47c2b0716a3432766414bf84c111045ffb3ca4058737ac9fb974f94439"
		)
	]
)