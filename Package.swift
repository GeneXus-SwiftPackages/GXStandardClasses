...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.2.0-beta.17.xcframework.zip",
			checksum: "189d8be174b6c77323e22557a650882df7dd373c848f9d04d5e08c1903e83c07"
		)
	]
)