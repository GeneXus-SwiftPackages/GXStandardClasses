...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.0.0-beta.29.xcframework.zip",
			checksum: "8b2b21ffff3c1957c93fb57d4c89f18c7afa2d8e70c8dc537af8d44c09fce9bc"
		)
	]
)