...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.10.xcframework.zip",
			checksum: "dcc00ad8c44235d50a289f6c9f6db974445effe387b8aade19f4a14b8dc65a17"
		)
	]
)