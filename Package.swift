...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.0.0-beta.5.xcframework.zip",
			checksum: "6d13f8f9ec84c903841cd9622619701c2c8d911ca605fe3953e94b1d2567c0c0"
		)
	]
)