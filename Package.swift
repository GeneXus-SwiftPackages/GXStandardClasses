...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.2.0-beta.19.xcframework.zip",
			checksum: "eb2d6ecad4510ed9a22cf16cb8f401007c8fabc72a3bcce89db4e7c0cd3b60ef"
		)
	]
)