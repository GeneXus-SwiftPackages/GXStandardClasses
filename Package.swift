...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.2.0-beta.41.xcframework.zip",
			checksum: "f36abc6470ca2ed42b0e24d3eaff75d21b360596a19cbc09d0d6c8f732b96cf1"
		)
	]
)