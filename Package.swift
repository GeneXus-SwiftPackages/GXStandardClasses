...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.34.xcframework.zip",
			checksum: "9f04d6f7e5fad2adb60efe52026b240825af51997793382497fb402ce26d7cb0"
		)
	]
)