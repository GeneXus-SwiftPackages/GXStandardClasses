...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.29.xcframework.zip",
			checksum: "db2612598ce816f25d7cd2bc2786d738c58424d8f3f5005a81c1aa299447a87f"
		)
	]
)