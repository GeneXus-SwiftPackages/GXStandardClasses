...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.1.0-beta.32.xcframework.zip",
			checksum: "514584e8bec0278fa459ca09812e5cafc01d1e70813826bdeea46fcdbb35bc7e"
		)
	]
)