...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-3.1.0-rc.3.xcframework.zip",
			checksum: "238444f868dcde6d0ae8eb800bc0a136c2b64b0e0c36cb634e2a255d096c7c04"
		)
	]
)