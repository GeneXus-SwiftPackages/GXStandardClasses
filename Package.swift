...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230524184838.xcframework.zip",
			checksum: "a58278444d4da8249c79baf7d5603007e0e6914d2aaae7afd4a0a2663feccf8a"
		)
	]
)