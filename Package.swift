...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.1.0-beta.15.xcframework.zip",
			checksum: "a3e7e222c1acd58a48b2c4492b73e383136f5cd09ff814a8b8b084a5a60d80f1"
		)
	]
)