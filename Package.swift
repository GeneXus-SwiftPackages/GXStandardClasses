...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.0.0-beta.4.xcframework.zip",
			checksum: "8db5884ce4f14f5eae58111018a51ce0551b5255050554310b4a0f0cf5477ec5"
		)
	]
)