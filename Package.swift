...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230428131619.xcframework.zip",
			checksum: "d2ae58c6f5474134868644ca9d91ccb0310ef3f93e1cd3fb380fdf9d63935cf9"
		)
	]
)