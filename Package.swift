...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.1.0-beta.3.xcframework.zip",
			checksum: "f71c98918eb21220faf91d45571c5ef5c7505884c35905cf06da1df138cede09"
		)
	]
)