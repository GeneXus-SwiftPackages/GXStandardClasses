...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.3.0-beta.8.xcframework.zip",
			checksum: "8427ab761847a0cdab6974e030835d76ae8b78976f0c0efed0406ea73a0b0bef"
		)
	]
)