...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.27.xcframework.zip",
			checksum: "d7053a07f993973f71ae6bcb39fc35d863a28e80a35973489de6ad066d1ebe50"
		)
	]
)