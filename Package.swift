...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.0.0-beta.10.xcframework.zip",
			checksum: "377fdb3c18030f5b187897ebfe7d2ada1a2af566395734b9ac3b8a4c3eece662"
		)
	]
)