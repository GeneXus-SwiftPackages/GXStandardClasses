...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230307184249.xcframework.zip",
			checksum: "9acffa692f86318f0747562aad8433c080884d46785dde95efb514107a7b3306"
		)
	]
)