...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.1.0-beta.8.xcframework.zip",
			checksum: "b888cf23beb96bc58935370795739d6be636dd8c36234fdf8a752f7c15ef237a"
		)
	]
)