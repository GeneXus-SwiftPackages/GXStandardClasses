...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-1.4.31.xcframework.zip",
			checksum: "f1b81cddf10cc28f7986f51b038f9e58571dab2bad287c206e641e6bed6768dc"
		)
	]
)