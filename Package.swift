...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-1.1.0-rc.1.xcframework.zip",
			checksum: "8be9830e4c4a642e97694cfb71d95360b58893e2ad78afc644d8588b8ed8180c"
		)
	]
)