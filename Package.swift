...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.0.0-beta.35.xcframework.zip",
			checksum: "92e993cb2009592c31f012b99eacbf9e9d2e0edf676581b5c74ebd32cc8e3777"
		)
	]
)