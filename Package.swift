...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-1.2.0.xcframework.zip",
			checksum: "8a55dc41eee5927126d17e66e942f166873d55ed172ef6dd6136299377cfd32c"
		)
	]
)