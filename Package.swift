...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.4.0-beta.16.xcframework.zip",
			checksum: "a7ec0be15680d82b3742c9c1d74fdb6d5e0fcf9c677946d8644d572b2d406dbf"
		)
	]
)