...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.2.0-beta.15.xcframework.zip",
			checksum: "0c60a633a3148c91a86062cd8f30fb8bd2ab5cf3a39cfb1a664a98c0aec6ed87"
		)
	]
)