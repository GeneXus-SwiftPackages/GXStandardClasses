...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.4.0-beta.5.xcframework.zip",
			checksum: "7676ab7169463c74dc48dc2ba11f0117d778e20f982e2d6649eaf3a56b4be9bd"
		)
	]
)