...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-1.4.29.xcframework.zip",
			checksum: "0101095b1a55760dc96552a14ec972b1986b48d5c7806c5d88894a8afaee2b33"
		)
	]
)