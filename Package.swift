...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.1.0-beta.11.xcframework.zip",
			checksum: "5160fed7686e115899706c30bce1b2b9c95bd0e9dd8c69b44ea7da2dff3c7af1"
		)
	]
)