...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.10.xcframework.zip",
			checksum: "d3241f04aab53b1f5d0c527fd51b433c0cc590ec3639042df0ceb532a837691f"
		)
	]
)