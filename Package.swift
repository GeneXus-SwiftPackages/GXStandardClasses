...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.4.0-beta.20.xcframework.zip",
			checksum: "ed5daf462d027d6ddb382723eb52dfb8210dc0636911282fd26c807b07df0061"
		)
	]
)