...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.9.xcframework.zip",
			checksum: "fe1be392bacc3a3b6c7c9d1c8be8b1f4ff0a402eabbf58fc6455377c679dc653"
		)
	]
)