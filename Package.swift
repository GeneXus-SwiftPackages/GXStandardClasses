...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230515145153.xcframework.zip",
			checksum: "07a671db592f10e0b39abfe5aa14de7414df27853efa1fbf913593304b706c6e"
		)
	]
)