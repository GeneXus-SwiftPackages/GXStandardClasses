...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-4.1.2.xcframework.zip",
			checksum: "2853c40c8d05b851256776e256a3880a9ff03f911538b0b4d985810c9b3617cb"
		)
	]
)