...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.19.xcframework.zip",
			checksum: "b713a002f3c0e31881ac8050f1c4d4605c9dd7c2b31a9432afaf5a7aa1c37785"
		)
	]
)