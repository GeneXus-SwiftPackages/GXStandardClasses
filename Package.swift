...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-1.4.30.xcframework.zip",
			checksum: "114efb5991f2427df5626df83cedc7902be410b755c9fd2afd2bec7763c7abb2"
		)
	]
)