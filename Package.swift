...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230504210908.xcframework.zip",
			checksum: "78e6b3da45eec6c3aec3e6109f7b709e017e9b76e53024b24fdeeef17eaad021"
		)
	]
)