...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.36.xcframework.zip",
			checksum: "a05208c112eca7b862d2f5e07ed7193d47a35c394e96558cd8a9b829bb18cd10"
		)
	]
)