...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-3.2.0-rc.9.xcframework.zip",
			checksum: "623652860b1444ec742bdd57bbaf7d5efcd1b200deda77fb9580cf6a36257b88"
		)
	]
)