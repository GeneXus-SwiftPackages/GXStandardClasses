...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.5.0-rc.28.xcframework.zip",
			checksum: "f5d52da912245a54831449282d0788377b54adedbd0a362b55c53ded860de123"
		)
	]
)