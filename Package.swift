...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-4.0.9.xcframework.zip",
			checksum: "67b1fdaca47226562ed76d7faf973e0d7f427471161d3a340c1109ec16d083e7"
		)
	]
)