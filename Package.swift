...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230428202437.xcframework.zip",
			checksum: "f351dd2fb415d0ed503b55fea39b0fd33bce795e2bfa9e2c34f4a039c90e610b"
		)
	]
)