...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.2.0-beta.22.xcframework.zip",
			checksum: "08a140c9fb9f279bba6dcf4fef523e4e3edb33af616a7fc03a48f2abc51ee7a6"
		)
	]
)