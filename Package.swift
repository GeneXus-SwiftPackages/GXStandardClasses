...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.3.0-beta.4.xcframework.zip",
			checksum: "bf0ef4c83a7edbf13701956ecd9eb2a5e499b9d7292380a37cc83fe38c2b5116"
		)
	]
)