...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.0.0-beta.49.xcframework.zip",
			checksum: "f24ef053c236fbec28d090127579b5458509d3624a070ab2fbd33e5218b20049"
		)
	]
)