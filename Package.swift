...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.2.0-beta.14.xcframework.zip",
			checksum: "ec2654bf273f0a3e74f82049021d3d164e84c2ee7e54c6f9b5757fb4d9cff88c"
		)
	]
)