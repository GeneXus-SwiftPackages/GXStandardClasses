...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-5.0.0-beta.1.xcframework.zip",
			checksum: "56e71c60aad34ab30b1e8f6c86f9e29f4c1157b65545df74d5d7694c3c418875"
		)
	]
)