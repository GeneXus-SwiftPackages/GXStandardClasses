...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.0.0-beta.48.xcframework.zip",
			checksum: "36b7449cd7f4642a3c7a094d0657f9ec5390204fd2e628798f5de9b3d7af6985"
		)
	]
)