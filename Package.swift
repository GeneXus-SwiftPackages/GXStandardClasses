...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-4.0.6.xcframework.zip",
			checksum: "e45bd25414d9f8c76ba8ceaf5097f8c3463aa9f34d21456b73fda3122a3091be"
		)
	]
)