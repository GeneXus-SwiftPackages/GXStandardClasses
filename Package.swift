...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.2.0-beta.23.xcframework.zip",
			checksum: "95cd5e7f8374720b710c3d5d500e6eb0df23dc1fe52a9635a080372431a6c629"
		)
	]
)