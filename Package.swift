...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.11.xcframework.zip",
			checksum: "08d1df61c6aca7e82c361932a2a30ec264d1f4e1a157d0c6897b72ddb5923699"
		)
	]
)