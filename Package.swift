...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.28.xcframework.zip",
			checksum: "21171886dce9d5a1bab85aecc16862365cacce7ada137bfdd2325fd4294981c8"
		)
	]
)