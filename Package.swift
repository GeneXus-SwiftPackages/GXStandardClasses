...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.1.0-beta.27.xcframework.zip",
			checksum: "55129f8889516dc451e7998dcd940021784772576c07bd6e93eba289f54f6e35"
		)
	]
)