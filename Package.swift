...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230503131704.xcframework.zip",
			checksum: "0f5e916c61948b51397853fd1ef1e63db9bfa9eb8603ae3094e4b9ced8e96b24"
		)
	]
)