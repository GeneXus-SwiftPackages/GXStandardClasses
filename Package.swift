...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.2.0-rc.29.xcframework.zip",
			checksum: "f77a0002d5f5090efdf3d5486997e8ccfd4d52f8d9e3ca48ba56f8e5c43849e5"
		)
	]
)