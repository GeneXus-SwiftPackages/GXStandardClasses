...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-3.0.0-rc.15.xcframework.zip",
			checksum: "bb32a24433d84671bd884f60c3e21dd7ea1b80f2385bbb794fbfcaed8b6a5e36"
		)
	]
)