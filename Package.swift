...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.2.0-beta.29.xcframework.zip",
			checksum: "dc4850372c3f396d87c8838bf06a2024ebff66ac36ac1100d79ab09ac3666581"
		)
	]
)