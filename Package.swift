...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.0.0-beta.38.xcframework.zip",
			checksum: "b7b15b6c7c7ceea8627747f8884b4f8ea801bd7c861b37e7df3f2f95f655ed0f"
		)
	]
)