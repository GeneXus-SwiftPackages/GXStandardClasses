...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-2.0.0-rc.36.xcframework.zip",
			checksum: "258290b3f0c7c4d6897aa94d635bfb3ba3f53bba02cd12badfab6b15b6753aee"
		)
	]
)