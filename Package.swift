...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230427140435.xcframework.zip",
			checksum: "f18addf5e3579705e314a58625561320f5c0e905ff8dd1d4f92eb74db32128a7"
		)
	]
)