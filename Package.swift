...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-5.0.0-rc.0.xcframework.zip",
			checksum: "cf2c8c83b052ab68823a886d5220c5d94197725290ad04efcf6bb964e6a828c0"
		)
	]
)