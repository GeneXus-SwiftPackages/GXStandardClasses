...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.0.0-beta.47.xcframework.zip",
			checksum: "112f529a26659ebf514e60dcf187ef9959e5712f07cb03f18ce3648cc41eb4bf"
		)
	]
)