...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.5.0-rc.26.xcframework.zip",
			checksum: "b17c1460d4309805a135699353c4c688f3256cdbc30b1dea399623bdddee1964"
		)
	]
)