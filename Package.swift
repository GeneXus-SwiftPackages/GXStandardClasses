...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.7.xcframework.zip",
			checksum: "12ae1cd22d2a370dc328ab8cc4b78f035c0b3b82918130078f3a21fc42828b02"
		)
	]
)