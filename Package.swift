...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.6.0-beta.4.xcframework.zip",
			checksum: "a00fd81036a9965de2911e06e15f2413ee1408260690a3fc6cbed783728a1b69"
		)
	]
)