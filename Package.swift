...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.19.xcframework.zip",
			checksum: "741cc1250b04030aacbc37549ec1b8c9ad36c71161ca8a8f1adb9d82a9e4a332"
		)
	]
)