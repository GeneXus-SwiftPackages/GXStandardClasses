...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.20.xcframework.zip",
			checksum: "8f761bc00257bb06907d16a31e2a02be689820c90b505b77ff1e679b9943a4e0"
		)
	]
)