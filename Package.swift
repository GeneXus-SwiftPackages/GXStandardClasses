...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.2.0-beta.21.xcframework.zip",
			checksum: "34e965ef2f2f3dd63b6e46046da49094aa03f65ee6a58621be07f60abfeecae8"
		)
	]
)