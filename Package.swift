...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.2.xcframework.zip",
			checksum: "d0fd809a34961a637a2e583f3e3db8656e8030978bbeb7120ce1586a9cd4deaf"
		)
	]
)