...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.1.0-beta.4.xcframework.zip",
			checksum: "3065a6072e9f4448f2f8dee218f4e1c5c9ef568afe1f8d2c82705e66f5f2bf84"
		)
	]
)