...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.1.0-beta.17.xcframework.zip",
			checksum: "a4e6c8422f4c27e1e3aa7a388e8d781465aa21c1cc8234ad258653e80638a105"
		)
	]
)