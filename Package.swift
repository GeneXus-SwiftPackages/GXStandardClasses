...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-1.4.0-rc.21.xcframework.zip",
			checksum: "334876381131511d79329361e7e088b113c19945b7fdbd2f9637e951216e89fc"
		)
	]
)