...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/preview/GXStandardClasses-3.1.0-rc.8.xcframework.zip",
			checksum: "477cd4b059fb7033e1d8fb1f7ed0828eac7fef0bb8b5c10737fa9840c78f39af"
		)
	]
)