...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.1.0-beta.24.xcframework.zip",
			checksum: "713f822b58524a52f7c6da5ddd1034cf3e7f5033638cb1f0afcb4554700e8cf8"
		)
	]
)