...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.24.xcframework.zip",
			checksum: "70d09c34deeefca8dd515ddf5e145344b5efba18a79f742313aecdb85d5d153a"
		)
	]
)