...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-3.2.0.xcframework.zip",
			checksum: "e6fdef0c9e41edfba8dc59e97a6427d03d4ba2815e3b211e782ae2ae78ebf173"
		)
	]
)