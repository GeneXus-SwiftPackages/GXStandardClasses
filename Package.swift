...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-3.1.0-beta.5.xcframework.zip",
			checksum: "0e4b97e38c0255b58d570dae0b84c4b641ba99bbf7ebb043d4244b1e06398e0e"
		)
	]
)