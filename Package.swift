...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.13.xcframework.zip",
			checksum: "70c1f09c8bc76bc765b16a3025e05ddb245670faeaba1552c85066976b63f0aa"
		)
	]
)