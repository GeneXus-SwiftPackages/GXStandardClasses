...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-2.2.0-beta.13.xcframework.zip",
			checksum: "da09933196dc6acd5e01f46566409befe4f7d7be2f7a1cc87cb7cd67a083e2dc"
		)
	]
)