...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.3.0-beta.7.xcframework.zip",
			checksum: "aab0e43f2d664159e67e4a64c636fc23bd342daf46870a09c591e547cc02070d"
		)
	]
)