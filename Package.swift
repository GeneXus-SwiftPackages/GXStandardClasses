...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.4.0-beta.8.xcframework.zip",
			checksum: "462eb151957660dcf4cb7f1860575fc6635145c8575335cd662c6501ab7e7633"
		)
	]
)