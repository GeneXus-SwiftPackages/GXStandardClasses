...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.27.xcframework.zip",
			checksum: "5533b5b030bc7da4ead4e5ed2129f03473a1a5fdd07d18203ba1f8e7fe8965de"
		)
	]
)