...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.5.0-beta.24.xcframework.zip",
			checksum: "6d0607c35fc659eda949f77916fdf7498a36ad477ecc6eb3a0abc018e6fd44aa"
		)
	]
)