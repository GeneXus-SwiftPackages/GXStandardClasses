...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-4.0.2.xcframework.zip",
			checksum: "112cedc9b0082dcb0d6bf5f72d7fa2b17ee0164b658f0b6277eaae097686856e"
		)
	]
)