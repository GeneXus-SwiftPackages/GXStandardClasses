...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230324153906.xcframework.zip",
			checksum: "bb64ce1b5a2a883a455dcd467a74a2fb9f83c838a54a1b4d0c7aca2fb49bf5fc"
		)
	]
)