...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.2.0-beta.23.xcframework.zip",
			checksum: "ebe64f9c3a66770d33ab4603cb45c5900229e829790811170bc47a4607d711dd"
		)
	]
)