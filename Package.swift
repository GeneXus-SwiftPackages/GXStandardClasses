...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-1.2.2.xcframework.zip",
			checksum: "c8c95ce92e32edd636091efbd18d51b7030b803b20e9c341ccb15218f3d98874"
		)
	]
)