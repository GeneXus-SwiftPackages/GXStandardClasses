...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-4.2.0-beta.3.xcframework.zip",
			checksum: "559e00e188a76e4af93361360f999e5452ac33107571eeeb8ef587efb89dd7ac"
		)
	]
)