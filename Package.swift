...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/releases/GXStandardClasses-1.3.6.xcframework.zip",
			checksum: "a14cbedffeed679da4477df9ed94a9a7b9875ab4f86ee9962ba8b8f46ea8d205"
		)
	]
)