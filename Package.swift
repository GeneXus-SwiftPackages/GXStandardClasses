...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXStandardClasses",
			url: "https://pkgs.genexus.dev/iOS/beta/GXStandardClasses-1.0.0-beta+20230531050040.xcframework.zip",
			checksum: "a61e2fe14359dcce7144017c1c53c6bd98829a1a9e3b85fe46ad6dc027a1f500"
		)
	]
)